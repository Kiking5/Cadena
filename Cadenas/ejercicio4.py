...
telefono_completo = input("Introduce el numero de telefono siguiendo el formato '(+34-913724710-56)': ")
telefono = telefono_completo[4:-3]
print(f"El numero de telefono sin prefijo y sin extension es: {telefono}")